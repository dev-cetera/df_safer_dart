...
sealed class Option<T extends Object> extends Monad<T> {
  ...
  Result<Option<R>> castOrConvert<R extends Object>();
}
...
final class Some<T extends Object> extends Option<T> {
  ...
  Result<Option<R>> castOrConvert<R extends Object>() {
    if (T == R) {
      return this as Result<Option<R>>;
    }
    final value = unwrap();
    if (value is R) {
      ...
      return Err(
        debugPath: ['Some', 'castOrConvert'],
        error: 'Cannot convert $T to $R',
      );
    }
  }
}
...
final class None<T extends Object> extends Option<T> {
  ...
  @override
  @pragma('vm:prefer-inline')
  Ok<None<R>> castOrConvert<R extends Object>() => const Ok(None());
}
