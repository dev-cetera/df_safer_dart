...
void main() {
  group('swap_none_ext', () {
    test('SwapNoneSyncExt.swap turns None<Sync<T>> into Sync<None<T>>', () {
      const None<Sync<int>> input = None();
      final Sync<None<int>> swapped = input.swap();
    ...
    test('SwapNoneAsyncExt.swap turns None<Async<T>> into Async<None<T>>', () async {
      const None<Async<int>> input = None();
      final Async<None<int>> swapped = input.swap();
    ...
    test('SwapNoneResolvableExt.swap turns None<Resolvable<T>> into Resolvable<None<T>>', () async {
      const None<Resolvable<int>> input = None();
      final Resolvable<None<int>> swapped = input.swap();
    ...
    test('SwapNoneOptionExt.swap turns None<Option<T>> into Some<None<T>>', () {
      const None<Option<int>> input = None();
      final Option<None<int>> swapped = input.swap();
    ...
    test('SwapNoneSomeExt.swap turns None<Some<T>> into Some<None<T>>', () {
      const None<Some<int>> input = None();
      final Some<None<int>> swapped = input.swap();
      expect(swapped.unwrap(), isA<None<int>>());
    });

    test('SwapNoneResultExt.swap turns None<Result<T>> into Ok<None<T>>', () {
      const None<Result<int>> input = None();
      final Result<None<int>> swapped = input.swap();
    ...
    test('SwapNoneOkExt.swap turns None<Ok<T>> into Ok<None<T>>', () {
      const None<Ok<int>> input = None();
      final Ok<None<int>> swapped = input.swap();
      expect(swapped.unwrap(), isA<None<int>>());
    });

    test('SwapNoneErrExt.swap turns None<Err<T>> into Err<None<T>>', () {
      const None<Err<int>> input = None();
      final Err<None<int>> swapped = input.swap();
