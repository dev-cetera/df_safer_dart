...
void main() {
  group('to_void_on_outcome_ext', () {
    test(
        'ToVoidOnOutcomeExt.toVoid returns the same instance typed as Outcome<void>',
        () {
    ...
    test(
        'ToVoidOnResolvableExt.toVoid returns the same instance typed as Resolvable<void>',
        () {
    ...
    test(
        'ToVoidOnAsyncExt.toVoid returns the same instance typed as Async<void>',
        () async {
    ...
    test(
        'ToVoidOnOptionExt.toVoid on Some returns same instance typed as Option<void>',
        () {
    ...
    test(
        'ToVoidOnOptionExt.toVoid on None returns same instance typed as Option<void>',
        () {
    ...
    test(
        'ToVoidOnSomeExt.toVoid returns the same Some instance typed as Some<void>',
        () {
    ...
    test(
        'ToVoidOnNoneExt.toVoid returns the same None instance typed as None<void>',
        () {
    ...
    test(
        'ToVoidOnResultExt.toVoid on Ok returns same instance typed as Result<void>',
        () {
    ...
    test(
        'ToVoidOnResultExt.toVoid on Err returns same instance typed as Result<void>',
        () {
    ...
    test(
        'ToVoidOnErrExt.toVoid returns the same Err instance typed as Err<void>',
        () {
